...
public class activity_enter_anim extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        appTitle = findViewById(R.id.txtapp_title);
        appSubtitle = findViewById(R.id.txtapp_subtitle);
    ...
    private void startAnimationSequence() {
        ...
        titleAnimThread = new Thread(() -> {
            try {
                ...
                runOnUiThread(() -> {
                    Animation slideIn = AnimationUtils.loadAnimation(activity_enter_anim.this, R.anim.slide_in_right);
        ...
        finalAnimThread = new Thread(() -> {
            try {
                ...
                runOnUiThread(() -> {
                    Animation pulse = AnimationUtils.loadAnimation(activity_enter_anim.this, R.anim.pulse);
                ...
                if (isRunning.get()) {
                    runOnUiThread(() -> {
                        Intent intent = new Intent(activity_enter_anim.this, MainPage.class);
